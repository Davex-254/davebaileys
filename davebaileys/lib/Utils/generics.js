...
const generateMessageIDV2 = (userId) => {
    ...
    return 'DAVE-' + hash.toString('hex').toUpperCase().substring(0, 18);
};
exports.generateMessageIDV2 = generateMessageIDV2;
// generate a random ID to attach to a message
const generateMessageID = () => 'DAVE-' + (0, crypto_1.randomBytes)(18).toString('hex').toUpperCase();
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/Davex-254/davebaileys/main/lib/Defaults/baileys-version.json';
    try {
