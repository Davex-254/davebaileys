...
const makeChatsSocket = (config) => {
    ...
    /**
       * Pin or Unpin a chat (private, group or newsletter)
       ...
       * Archive a chat
       * @param jid - JID of the chat
       * @param lastMessages - last message(s) in the chat (required by WA for sync)
       */
      const archiveChat = (jid, lastMessages) => {
          return chatModify({ archive: 'true', lastMessages }, jid);
      };
      /**
       * Unarchive a chat
       * @param jid - JID of the chat
       * @param lastMessages - last message(s) in the chat
       */
      const unarchiveChat = (jid, lastMessages) => {
          return chatModify({ archive: 'false', lastMessages }, jid);
      };
      /**
       * Mark a chat as read
       * @param jid - JID of the chat
       * @param lastMessages - last message(s)
       */
      const markChatRead = (jid, lastMessages) => {
          return chatModify({ markRead: true, lastMessages }, jid);
      };
      /**
       ...
       * @param lastMessages - last message(s)
       */
      const markChatUnread = (jid, lastMessages) => {
