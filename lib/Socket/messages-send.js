...
const DavexStatus = require("./gcstatus");
...
const makeMessagesSocket = (config) => {
    ...
    const davexStatus = new DavexStatus(Utils_1, waUploadToServer, relayMessage, config, sock);
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (
                ...
                return await davexStatus.handleGroupStory(content, jid, options.quoted);
            } else {
