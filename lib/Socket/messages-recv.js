...
const makeMessagesRecvSocket = (config) => {
    ...
    return {
        ...
        antiUtils: {
            ...
            /** Returns true if message contains a group mention (@g.us) */
            hasGroupMention: (msg) => {
                var _a, _b, _c, _d;
                const ctx = ((_b = (_a = msg === null || msg === void 0 ? void 0 : msg.message) === null || _a === void 0 ? void 0 : _a.extendedTextMessage) === null || _b === void 0 ? void 0 : _b.contextInfo) ||
                    ((_d = (_c = msg === null || msg === void 0 ? void 0 : msg.message) === null || _c === void 0 ? void 0 : _c.imageMessage) === null || _d === void 0 ? void 0 : _d.contextInfo) || {};
                return ((ctx.mentionedJid) || []).some(j => j.endsWith('@g.us'));
            },
            /** Returns true if the message is a sticker */
            isSticker: (msg) => { var _a; return !!((_a = msg === null || msg === void 0 ? void 0 : msg.message) === null || _a === void 0 ? void 0 : _a.stickerMessage); },
            /** Returns true if the message is an image */
            isImage: (msg) => { var _a; return !!((_a = msg === null || msg === void 0 ? void 0 : msg.message) === null || _a === void 0 ? void 0 : _a.imageMessage); },
            /** Returns true if the message is audio or a voice note */
            isAudio: (msg) => { var _a; return !!((_a = msg === null || msg === void 0 ? void 0 : msg.message) === null || _a === void 0 ? void 0 : _a.audioMessage); },
            /** Returns true if the message is a video */
            isVideo: (msg) => { var _a; return !!((_a = msg === null || msg === void 0 ? void 0 : msg.message) === null || _a === void 0 ? void 0 : _a.videoMessage); },
            /** Returns true if the message is a document/file */
            isDocument: (msg) => { var _a; return !!((_a = msg === null || msg === void 0 ? void 0 : msg.message) === null || _a === void 0 ? void 0 : _a.documentMessage); },
            /** Returns true if the message is a contact card */
            isContact: (msg) => { var _a, _b; return !!((_a = msg === null || msg === void 0 ? void 0 : msg.message) === null || _a === void 0 ? void 0 : _a.contactMessage) || !!((_b = msg === null || msg === void 0 ? void 0 : msg.message) === null || _b === void 0 ? void 0 : _b.contactsArrayMessage); },
            /** Returns true if the message is a location */
            isLocation: (msg) => { var _a, _b; return !!((_a = msg === null || msg === void 0 ? void 0 : msg.message) === null || _a === void 0 ? void 0 : _a.locationMessage) || !!((_b = msg === null || msg === void 0 ? void 0 : msg.message) === null || _b === void 0 ? void 0 : _b.liveLocationMessage); },
            /** Returns a string describing the message type */
            getType: (msg) => {
                var _a;
                const m = (_a = msg === null || msg === void 0 ? void 0 : msg.message) !== null && _a !== void 0 ? _a : {};
